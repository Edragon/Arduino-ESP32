...
//老虎
const char* laohugif[] = {"/hlh1.bmp","/hlh2.bmp","/hlh1.bmp","/hlh2.bmp","/hlh1.bmp","/hlh2.bmp","/hlh1.bmp","/hlh2.bmp","/hlh1.bmp","/hlh2.bmp","/hlh1.bmp","/hlh2.bmp"};//, hlh10, hlh11, hlh12, hlh13, hlh14, hlh15, hlh16, hlh17, hlh18};
 File fsUploadFile;
//bdd
...
//  const char* data_cYear = data["cYear"]; // "辛丑年"
  ...
  int data_iDay = 6; // 6
  const char* data_iMonthChinese = "十一月"; // "十一月"
  const char* data_iDayChinese = "初六"; // "初六"
  int data_sYear = 2021; // 2021
  int data_sMonth = 12; // 12
  int data_sDay = 9; // 9
  const char* data_cYear = "辛丑年"; // "辛丑年"
...
//  const char* data_solarFestival = data["solarFestival"]; // " 世界足球日"
  const char* data_solarFestival = "世界足球日"; // " 世界足球日"
...
//  const char* data_lunarFestival = data["lunarFestival"]; // nullptr
  const char* data_solarTerms = "nullptr节气"; // nullptr节气
