...
void handleRoot() {
  ...
  if (xSemaphoreTake(fileMutex, pdMS_TO_TICKS(2000)) == pdTRUE) {
    ...
    html += ".delete{color:#ff4444;} img{max-width:200px; border:1px solid #666;}</style>";
    ...
    while(file){
        ...
        if(fileName.endsWith(".jpg")) {
            ...
            html += "<td><a href='/download?file=" + fileName + "' target='_blank'>View</a> | ";
            html += "<a href='/delete?file=" + fileName + "' class='delete'>Delete</a></td>";
            html += "</tr>";
        }
