...
int PIN_LORA_DIO_1 = 0;  // LORA DIO_1
...
int RADIO_RXEN = 5;	  // LORA ANTENNA RX ENABLE
...
/** Simple event flag for ESP8266 compatibility */
...
// No HW config required
	...
	// No semaphore needed for ESP8266, use eventPending flag
	eventPending = false;
