...
// Motor LEDC Channels (shared with servo timer)
#define LEFT_MOTOR_IN1_CHANNEL LEDC_CHANNEL_0
#define LEFT_MOTOR_IN2_CHANNEL LEDC_CHANNEL_1
#define RIGHT_MOTOR_IN1_CHANNEL LEDC_CHANNEL_2
#define RIGHT_MOTOR_IN2_CHANNEL LEDC_CHANNEL_3
